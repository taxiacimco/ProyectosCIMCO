    ...
    return (
        <div className="min-h-screen bg-[#09090b] font-mono text-zinc-100 p-6 flex flex-col gap-6">
            <header className="flex items-center gap-3 border-b border-white/5 pb-4">
                ...
                <div>
                    <h1 className="text-xl font-black uppercase tracking-widest text-white">Historial Operativo</h1>
                    <p className="text-[9px] text-zinc-500 uppercase tracking-wider">Registro de trayectos consolidados bajo modalidad de parrillero</p>
                </div>
            </header>
            ...
            <div className="space-y-4">
                {loading ? (
                    <div className="flex items-center gap-2 text-zinc-500 text-xs uppercase animate-pulse">
                        <Loader size={14} className="animate-spin text-cyan-400" /> Leyendo bases de datos...
                    </div>
                ) : historial.length === 0 ? (
                    ...
                    historial.map(viaje => (
                        <div key={viaje.id} className="backdrop-blur-md bg-[#121214]/80 p-5 rounded-2xl border border-white/5 flex flex-col gap-3 hover:border-white/10 transition-all shadow-lg">
                            <div className="flex justify-between items-center border-b border-white/5 pb-3">
                                <div>
                                    <p className="text-[9px] text-zinc-500 uppercase tracking-widest font-black">Monto Liquidado</p>
