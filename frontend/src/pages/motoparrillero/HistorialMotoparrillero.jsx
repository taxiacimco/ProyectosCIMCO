...
import { FileText, MapPin, CheckCircle, Loader, AlertTriangle, RefreshCw, Users } from 'lucide-react';

const HistorialMotoparrillero = () => {
    const { user } = useAuth();
    ...
    const fetchHistorial = useCallback(async () => {
        ...
        try {
            ...
            const endpoint = `${cleanEndpoint}?conductorId=${conductorId}&tipoServicio=motoparrillero`;
        ...
        try {
            ...
            console.error("❌ [CIMCO-CRITICAL-PARRILLERO] Fallo en fallback NoSQL:", noSqlErr);
            ...
            <div className="w-full max-w-4xl mx-auto relative z-10 flex flex-col gap-6">
                ...
                <header className="backdrop-blur-md bg-[#121214]/80 p-5 rounded-2xl border border-white/5 flex items-center justify-between gap-4 shadow-xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-black uppercase tracking-widest text-white flex items-center gap-2">
                                Historial Parrillero
                            </h1>
                            <p className="text-[10px] text-zinc-500 uppercase tracking-wider font-bold mt-0.5">Bitácora de servicios completados en red motoparrillero</p>
                        </div>
                    </div>
                    <div className="hidden sm:flex items-center gap-2 bg-zinc-950/60 px-3 py-1.5 rounded-xl border border-white/5 text-[9px] text-zinc-400 uppercase font-bold tracking-widest">
                        ...
                        <span>{historial?.length || 0} Servicios</span>
                    </div>
                </header>
...
export default HistorialMotoparrillero;